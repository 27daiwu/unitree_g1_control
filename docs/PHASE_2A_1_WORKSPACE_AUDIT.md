...
- Deleted files: the superseded LowState smoke test and the historical Phase 2C0 MuJoCo audit; conclusions are retained in `docs/phase_2c0_mujoco_model_audit.txt`.
